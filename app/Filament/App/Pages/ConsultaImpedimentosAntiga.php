...
class ConsultaImpedimentosAntiga extends Page implements HasForms
{
    use InteractsWithForms;

    protected string $view = 'filament.app.pages.consulta-impedimentos-antiga';
    protected static string | \UnitEnum | null $navigationGroup = 'Gestão';
    protected static string | \BackedEnum | null $navigationIcon = Heroicon::OutlinedNoSymbol;
    protected static ?int $navigationSort = 11;
    protected static ?string $navigationLabel = 'Consulta Impedimentos (Antiga)';
    protected static ?string $title = 'Consulta de Impedimentos (Método Antigo)';
