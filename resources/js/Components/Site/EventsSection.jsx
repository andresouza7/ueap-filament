                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
                    ...
                    <div className="flex flex-col">
                        <div className="flex items-center gap-3 mb-12">
                            ...
                            <Calendar className="text-ueap-primary shrink-0" size={32} />
                            <h3 className="text-2xl md:text-3xl font-bold text-ueap-primary uppercase tracking-tighter">
                                Eventos & Ações
                            </h3>
                        </div>
                        ...
                        <div className="mt-8 pt-4 border-t border-gray-200/60">
                            <a href={route('site.post.list', { type: 'event' })} className="inline-flex items-center gap-2 text-[10px] font-bold text-ueap-primary uppercase tracking-[0.2em] hover:text-[#89c02e] transition-colors group">
                    ...
                    <div className="space-y-12 md:space-y-16">
                        <div>
                            ...
                            <h3 className="text-2xl md:text-3xl font-bold text-ueap-primary uppercase tracking-tighter mb-12 lg:mb-10">
                        ...
                        <div className="bg-ueap-primary p-8 md:p-12 relative overflow-hidden shadow-2xl rounded-sm">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <a href="https://www.instagram.com/ueapoficial/" className="flex-1 bg-white text-ueap-primary flex items-center justify-center gap-3 py-4 font-bold text-[10px] uppercase tracking-[0.2em] hover:brightness-90 transition-all group">
                                        <Instagram size={20} /> INSTAGRAM
                                    </a>
                                    <a href="https://www.youtube.com/channel/UCB6gc6QS_nJmCP5rNBh0kQQ" className="flex-1 bg-ueap-accent text-ueap-primary flex items-center justify-center gap-3 py-4 font-bold text-[10px] uppercase tracking-[0.2em] hover:brightness-90 transition-all group">
