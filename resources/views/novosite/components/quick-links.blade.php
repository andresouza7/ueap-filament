<!-- Quick Links Section -->
<section class="py-10 -mt-28 relative z-10">
    <div class="max-w-ueap mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <a href="#"
                ...
                <span
                    class="text-sm font-bold text-gray-700 text-center leading-tight group-hover:text-red-600 transition-colors">Calendário<br>Acadêmico</span>
            </a>
            ...
            <a href="#"
                ...
                <span
                    class="text-sm font-bold text-gray-700 text-center leading-tight group-hover:text-emerald-600 transition-colors">Legislação<br>Ueap</span>
            </a>
            ...
            <a href="#"
                ...
                <span
                    class="text-sm font-bold text-gray-700 text-center leading-tight group-hover:text-teal-700 transition-colors">Instruções<br>Normativas</span>
            </a>
            ...
            <a href="#"
                ...
                <span
                    class="text-sm font-bold text-gray-700 text-center leading-tight group-hover:text-blue-600 transition-colors">Resoluções<br>CONSU</span>
            </a>
            ...
            <a href="#"
                ...
                <span
                    class="text-sm font-bold text-gray-700 text-center leading-tight group-hover:text-amber-600 transition-colors">Licitações</span>
            </a>
            ...
            <a href="#"
                ...
                <span
                    class="text-sm font-bold text-gray-700 text-center leading-tight group-hover:text-rose-600 transition-colors">Processos<br>Seletivos</span>
            </a>
