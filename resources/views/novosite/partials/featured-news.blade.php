        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <a href="#"
               class="lg:col-span-2 relative rounded-lg overflow-hidden group cursor-pointer shadow-md hover:shadow-xl transition-all duration-300 
                      h-[10rem] sm:h-[24rem] lg:h-[31.5rem]">
                ...
                <div class="relative z-10 p-4 md:p-6 flex flex-col justify-end h-full text-white">
                    <h2
                        class="text-sm md:text-2xl font-semibold leading-tight mb-2 drop-shadow-lg transition-all duration-200 
                    ...
                    <p class="text-xs md:text-sm text-gray-200 mb-2">12 de Novembro, 2025</p>
                </div>
            </a>
            ...
            <div class="flex flex-col gap-4">
                ...
                <!-- CARD MENOR 1 -->
                <a href="#"
                   class="relative rounded-lg overflow-hidden group cursor-pointer shadow-md hover:shadow-xl transition-all duration-300 h-[10rem] lg:h-[15.25rem]">
                    <img src="https://picsum.photos/id/1049/600/400"
                         alt="Notícia secundária"
                         class="absolute inset-0 w-full md:h-full object-cover brightness-90 group-hover:brightness-110 group-hover:contrast-110 transform group-hover:scale-110 transition-all duration-500">
                    ...
                    <div class="relative z-10 p-4 text-white flex flex-col justify-end h-full">
                        <h3
                            class="text-sm md:text-lg font-semibold leading-tight drop-shadow-lg transition-all duration-200 
                                   group-hover:underline decoration-accent-yellow decoration-2 underline-offset-[3px]">
