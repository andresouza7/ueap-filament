...
<section class="relative py-10 px-6 lg:py-24">
    <!-- Background Gradient -->
    ...
    <div class="max-w-screen-xl px-4 mx-auto relative z-20">
        ...
        <div class="lg:pt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            <div
                ...
                <div>
                    <h3 class="text-base font-semibold text-blue-800">PIBID</h3>
                    <p class="text-gray-600 text-sm">Programa de Bolsas de Iniciação à Docência.</p>
                </div>
            </div>
            ...
            <div
                ...
                <div>
                    <h3 class="text-base font-semibold text-blue-800">PRP</h3>
                    <p class="text-gray-600 text-sm">Programa de Pesquisa e Inovação.</p>
                </div>
            </div>
            ...
            <div
                ...
                <div>
                    <h3 class="text-base font-semibold text-blue-800">PROACE</h3>
                    <p class="text-gray-600 text-sm">Programa de Ações Comunitárias e Extensão.</p>
                </div>
            </div>
            ...
            <div
                ...
                <div>
                    <h3 class="text-base font-semibold text-blue-800">PROAPE</h3>
                    <p class="text-gray-600 text-sm">Programa de Apoio ao Ensino.</p>
                </div>
            </div>
            ...
            <div
                ...
                <div>
                    <h3 class="text-base font-semibold text-blue-800">PROBICT</h3>
                    <p class="text-gray-600 text-sm">Programa de Bolsas de Iniciação Científica e Tecnológica.</p>
                </div>
            </div>
            ...
            <div
                ...
                <div>
                    <h3 class="text-base font-semibold text-blue-800">PROMONITORIA</h3>
                    <p class="text-gray-600 text-sm">Programa de Monitoria Acadêmica.</p>
                </div>
            </div>
        </div>
    </div>
